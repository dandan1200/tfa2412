...
/**
 * Precompiled assignment1.java-application-conventions script plugin.
 **/
public class Assignment1JavaApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_Assignment1JavaApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("assignment1.java-common-conventions");
            target.getPluginManager().apply("application");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_Assignment1JavaApplicationConventions").asSubclass(BasicScript.class);
